  ...
  return (
    <div className="min-h-screen bg-slate-900 flex flex-col justify-between text-slate-100 font-sans">
      ...
      <header className="pt-12 text-center px-4">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#128243]/10 border border-[#128243]/20 text-[#25a85c] text-xs font-semibold uppercase tracking-wider mb-4">
      ...
      <main className="max-w-md w-full mx-auto px-4 py-8">
        <div className="bg-slate-800/80 backdrop-blur-md rounded-2xl shadow-2xl p-6 sm:p-8 border border-slate-700 space-y-4">
          <Link
            href="/login"
            className="w-full flex items-center justify-between p-4 bg-[#128243] hover:bg-[#0e6835] text-white rounded-xl font-semibold shadow-lg shadow-[#128243]/30 transition transform hover:-translate-y-0.5"
          >
            <span className="flex items-center gap-3">
              <LogIn className="w-5 h-5" /> Portal Admin / Petugas
            </span>
            <span className="text-xs bg-[#0e6835]/50 px-2.5 py-1 rounded-md">Masuk</span>
          </Link>
