  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-between text-slate-800 font-sans">
      ...
      <header className="pt-14 text-center px-4">
        ...
        <p className="text-slate-600 mt-2.5 text-sm sm:text-base max-w-lg mx-auto font-medium">
      ...
      <main className="max-w-md w-full mx-auto px-4 py-8">
        <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 border border-slate-200/80 space-y-4">
          <Link
            href="/login"
          ...
          <Link
            href="/rekap"
            className="w-full flex items-center justify-between p-4 bg-slate-50 hover:bg-slate-100 text-slate-800 rounded-xl font-bold border border-slate-200 transition transform hover:-translate-y-0.5"
          >
            <span className="flex items-center gap-3">
              <ClipboardList className="w-5 h-5 text-[#128243]" /> Lihat Rekap Kehadiran
            </span>
            <span className="text-xs bg-slate-200/70 px-2.5 py-1 rounded-md font-semibold text-slate-600">Publik</span>
          </Link>
          ...
          >
            ...
            <span className="text-xs bg-slate-200/70 px-2.5 py-1 rounded-md font-semibold text-slate-600">Cetak</span>
          </Link>
        </div>
      </main>
