          ...
          {selectedAcara && (
            <div className="grid grid-cols-5 gap-3 print:gap-2 mb-4">
              <div className="bg-white p-3 rounded-xl print:rounded-lg shadow-sm print:shadow-none border border-gray-200 flex flex-col justify-between">
                <p className="text-[11px] text-gray-600 font-semibold leading-tight">Total Pengurus</p>
                <p className="text-lg print:text-base font-bold text-gray-900 mt-1">{totalPengurus}</p>
              </div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-sm print:text-xs print-border-table border-collapse">
                  <thead className="bg-gray-50 print:bg-white border-b text-xs print:text-[11px] uppercase text-gray-700 font-bold">
                    <tr>
                      <th className="p-3 print:p-2 border-gray-200 w-2/5">NAMA PENGURUS</th>
                      <th className="p-3 print:p-2 border-gray-200 w-1/4">KELOMPOK</th>
                  ...
                  <tbody className="divide-y divide-gray-100 print:divide-gray-300">
                    {filteredPengurus.length === 0 ? (
                      ...
                      filteredPengurus.map((pengurus) => {
                        ...
                        return (
                          <tr key={pengurus.id} className="hover:bg-gray-50/50 transition">
